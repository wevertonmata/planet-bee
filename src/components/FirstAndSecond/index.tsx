  ...
  return (
    <Sticky className="second">
        ...
        <motion.div style={{
          ...
          borderRadius: '4px',border: '4px solid #fff',
          opacity: frameOpacity, scale: frameScale
        }} />
    </Sticky>
  );
};
...
const First: React.FC = () => {
  ...
  const firstScale = useTransform(scrollYProgress, [0.198,0.264,0.558,0.627], [1,0.511,0.511,1]) //[inicio,fim,incio2,fim], [inicio,fim,incio2,fim]
  ...
  const rightSideY = useTransform(scrollYProgress, [0.047,0.093], ['50vh','0vh'])
  const offsetY = useTransform(scrollYProgress, [0.320,0.397,0.461,0.53], ['0%','-100%','-100%','-200%'])
